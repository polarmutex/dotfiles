...
local maps = {
    ...
    {n, "<space>wr", "<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>", silent}, {
        n, "<space>wl",
        "<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>", silent,
    ...
    -- Testing
    {n, "<leader>T", "<cmd>Ultest<cr>"}, {n, "]t", "<plug>(ultest-next-fail)"},
    {n, "[t", "<plug>(ultest-prev-fail)"}, -- DAP
    ...
    {
        n, "<leader>gc",
        ":lua require(\"polarmutex.plugins.telescope\").git_commits()<CR>",
    },
    {
        n, "<leader>gd",
        ":lua require(\"polarmutex.plugins.telescope\").git_bcommits()<CR>",
    },
    {n, "<leader>gi", ":lua require(\"polarmutex.plugins.telescope\").gh_issues()<CR>"},
    {
        n, "<leader>gr",
        ":lua require(\"polarmutex.plugins.telescope\").gh_pull_request()<CR>",
    ...
    {n, "<leader>u", ":UndotreeShow<CR>"}, -- Move windows
    -- { n, '<C-j>','<C-W><C-J>'},
    -- { n, '<C-k>','<C-W><C-K>'},
    -- { n, '<C-l>','<C-W><C-L>'},
    -- { n, '<C-h>','<C-W><C-H>'},
